...
To specify the coordinate values required to draw this map, I separated and read the latitude and longitude of each data point. In addition, for Leaflet function, I also got the basic layer from Esri.WorldStreetMap to add geographical boundaries to the map.
