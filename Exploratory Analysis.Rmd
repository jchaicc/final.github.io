...
```{r}
slp_df %>%
  filter(education_level!="don't know" & education_level!="refused") %>%
  group_by(education_level) %>%
  summarize(ave_slp_hr=mean(weekday_slp_hr)) %>%
  mutate(education_level=fct_reorder(education_level,ave_slp_hr)) %>%
  plot_ly(x=~ education_level,y=~ave_slp_hr,color=~education_level,type="bar")
...
slp_df %>%
  ...
  plot_ly(x=~ education_level,y=~obs,color=~education_level,type="bar")
