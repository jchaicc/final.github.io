...
#### model training
```{r}
xgb2 = xgboost(data = dtrain, max.depth = 10, nround = 1000, objective = "binary:logistic")
print(xgb2)
```
...
From the table, we find:
1. the logistic model works well on sufficient sleep. $\frac{976}{976+195} = 83.35\%$
2. the logistic model works not well on sufficient sleep. $\frac{70}{70+292} =  19.34\%$
3. the total accuracy of the model prediction is $\frac{70+976}{70+192+976+195} = 68.23\%$
