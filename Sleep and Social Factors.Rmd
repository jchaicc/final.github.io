...
<<<<<<< HEAD:Exploratory Analysis.Rmd
                               )) %>% 
  mutate(ave_slp_hr = (5*weekday_slp_hr + 2*weekend_slp_hr)/7)
=======
                               )) 
  
>>>>>>> 144ef921ca384fb7b4a83a26d87e979447bb2ff0:Sleep and Social Factors.Rmd
...
### refine linear model using stepwise method 
```{r}
